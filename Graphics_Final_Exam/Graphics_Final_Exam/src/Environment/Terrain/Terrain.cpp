...
{
	model->LoadModel("Assets/Models/TerrianFinal_UV_XZ.ply");
	...
	model->meshes[0]->material->AsMaterial()->diffuseTexture->LoadTexture("Assets/Models/TerrainTex.jpg");
	model->meshes[0]->material->AsMaterial()->textureTiling = glm::vec2(5000,5000);
